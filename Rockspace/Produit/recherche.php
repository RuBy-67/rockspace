...
<body>
  ...
  <main>
    ...
    // Récupération des produits de la table "articles"
    $sql = "SELECT * FROM articles WHERE nom LIKE '%$texteRecherche%'";
    ...
    if ($result->num_rows > 0) {
      ...
      echo ' <p class="error"></p>Aucun produit trouvé.';
    }
    ?>
  </main>
